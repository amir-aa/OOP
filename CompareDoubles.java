public class CompareDoubles
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("The claim that the difference of " + firstNumber +
                    " and " + secondNumber + " equals 1.0 is " + 
                    (differenceOfNumbers == 1.0));
        ...
        System.out.println("The claim that the difference of " + firstNumber + 
                    " and " + secondNumber + " equals 1.0 is " + 
                    (Math.abs(differenceOfNumbers - 1.0) < EPSILON));
        /* Here, instead of directly comparing the values of differenceOfNumbers
         and 1.0 with the operator ==, we compare their difference to a very 
         small constant that we call EPSILON.
